const { scrapeHtml } = require('./src/app/actions.ts');
...
async function testImageScraping() {
  console.log('🧪 Testing Image Scraping from Raw HTML...\n');
  
  try {
    console.log('📄 HTML Length:', sampleHtml.length, 'characters');
    console.log('🖼️ Expected Images: 5 Dubizzle property images\n');
    
    const result = await scrapeHtml(sampleHtml, 'https://test-property-url.com');
